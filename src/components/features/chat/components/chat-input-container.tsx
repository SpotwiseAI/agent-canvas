...
export function ChatInputContainer({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-[var(--oh-surface)] border border-border shadow-[var(--oh-field-shadow)] box-border content-stretch flex flex-col items-start justify-center p-4 relative rounded-[16px] w-full",
